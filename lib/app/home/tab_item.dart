...
class TabItemData {
  ...
  static const Map<TabItem, TabItemData> allTabs = {
    ...
    TabItem.neighborhood: TabItemData(label: 'neighborhood', icon: Icons.deck_rounded),
    TabItem.chats: TabItemData(label: 'Chats', icon: Icons.chat_bubble_outline_rounded),
